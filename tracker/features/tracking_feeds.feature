...
Feature: User can track feeds
  ...
  Scenario: Adding new tracking entries - timer mode
    ...
    Then there is 1 tracking entry started at 10:00 with 15 minutes length for tomasz@gmail.com
  ...
  Scenario: Adding new tracking entries - fixed time mode
    ...
    Then there is 1 tracking entry started at 10:00 with 20 minutes length for tomasz@gmail.com